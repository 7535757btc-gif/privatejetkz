...
const ru: Dict = {
  ...
  who: {
    ...
    p2: "Тихий салон, чистота перед каждым выездом, капитанские кожаные кресла с атаманками, тёплая подсветка. Вы получаете один и тот же уровень сервиса — какая бы машина ни приехала.",
  ...
  perks: {
    ...
    items: [
      ...
      { t: "Тишина в салоне", d: "Шумоизоляция и капитанские кресла с атаманками" },
      { t: "Подача вовремя", d: "Минута в минуту, никаких отговорок" },
      { t: "Помощь с багажом", d: "Водитель в костюме встречает с табличкой" },
      { t: "Конфиденциальность", d: "Тонировка, NDA по запросу" },
    ],
  },
  tariffs: {
    eyebrow: "Тарифы",
  ...
  interior: {
    eyebrow: "Капитанские кресла с атаманками",
  ...
  reviews: {
    ...
    items: [
      ...
      { name: "Дмитрий Власов", role: "Бизнес-поездка Астана — Омск", text: "Нужно было доехать до Омска без пересадок и нервов. Согласовали маршрут в WhatsApp за 10 минут. Водитель в костюме, чистый салон, две остановки в пути по моему запросу. Обратно — та же машина, тот же водитель. Большая редкость в Казахстане." },
      ...
      { name: "Олег Краснов", role: "Встреча делегации", text: "Принимали партнёров из ОАЭ — нужны были 3 одинаковые машины. Получили ровно то, что обещали: 3 чёрные Staria LUXE, водители в одинаковых костюмах, координатор на связи. Гости были в восторге от салона." },
  ...
  fleetPage: {
    ...
    feature: [
      ...
      { t: "Раздвижные двери", d: "Удобный вход для VIP-гостей" },
  ...
  servicesPage: {
    ...
    items: [
      ...
      },
      {
        ...
        waText: "Здравствуйте, нужен межгород на Staria.",
      },
      {
        name: "Встреча делегаций",
        price: "Индивидуально",
...
const kz: Dict = {
  ...
  perks: {
    ...
    items: [
      ...
      { t: "Жүкке көмек", d: "Костюмдегі жүргізуші тақтайшамен қарсы алады" },
      { t: "Құпиялылық", d: "Тонировка, сұраныс бойынша NDA" },
    ],
  },
  tariffs: {
    eyebrow: "Тарифтер",
  ...
  interior: {
    eyebrow: "Капитан орындықтары атаманкамен",
  ...
  reviews: {
    ...
    items: [
      ...
      { name: "Дмитрий Власов", role: "Іскерлік сапар Астана — Омбы", text: "Омбыға ауыстырусыз және жүйкесіз жетуім керек еді. WhatsApp-та маршрутты 10 минутта келістік. Костюмдегі жүргізуші, таза салон, жолда екі тоқтау. Қайтарда — сол көлік, сол жүргізуші." },
      ...
      { name: "Олег Краснов", role: "Делегацияны қарсы алу", text: "БАӘ серіктестерін қарсы алдық — 3 бірдей көлік керек болды. Уәде еткендей: 3 қара Staria LUXE, бірдей костюмдегі жүргізушілер, координатор байланыста. Қонақтар салонға таңқалды." },
  ...
  fleetPage: {
    ...
    feature: [
      ...
      { t: "Сырғымалы есіктер", d: "VIP қонақтарға қолайлы кіру" },
...
const en: Dict = {
  ...
  perks: {
    ...
    items: [
      ...
      { t: "Help with luggage", d: "Suited driver meets you with a sign" },
      { t: "Confidentiality", d: "Tinted windows, NDA on request" },
    ],
  },
  tariffs: {
    eyebrow: "Tariffs",
  ...
  marquee: ["PRIVATE JET KZ", "10 YEARS", "ASTANA", "HYUNDAI STARIA LUXE", "24 / 7", "VIP TRANSFER"],
  airport: {
  ...
  reviews: {
    ...
    items: [
      ...
      { name: "Dmitry Vlasov", role: "Astana — Omsk business trip", text: "Needed to reach Omsk without transfers or stress. Agreed the route over WhatsApp in 10 minutes. Suited driver, clean cabin, two stops on request. Same car and same driver on the way back — a rarity in Kazakhstan." },
      ...
      { name: "Oleg Krasnov", role: "Delegation pickup", text: "We hosted partners from the UAE — needed 3 identical cars. Got exactly what was promised: 3 black Staria LUXE, drivers in matching suits, coordinator on call. Guests were blown away by the cabin." },
  ...
  fleetPage: {
    ...
    feature: [
      ...
      { t: "Sliding doors", d: "Easy entrance for VIP guests" },
